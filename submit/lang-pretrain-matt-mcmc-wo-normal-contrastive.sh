...
python tools/train.py \
  --config-file configs/matterport3d/lang-pretrain-matt-mcmc-wo-normal-contrastive.py \
  --options \
    save_path=exp_runs/lang_pretrainer/lang-pretrain-matt-mcmc-wo-normal-contrastive \
