...
class iBOTPatchLoss(nn.Module):
    ...
    def softmax_center_teacher(self, teacher_patch_tokens, teacher_temp):
        ...
        # softmax_center_teacher torch.Size([1, 3732, 65536]) 0.04
        # center torch.Size([1, 1, 65536])
    ...
    def forward_masked(
        ...
        # student_masks_flat torch.Size([128, 196]) tensor(3729, device='cuda:0')
        ...
        # loss torch.Size([3726])
        # masks_weight torch.Size([3726])

        loss = loss * masks_weight
        return -loss.sum() / view_nums
